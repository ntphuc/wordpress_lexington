...
function tie_ad_post_content($content) {
	if (!current_user_can('manage_options') && is_single()){
		echo '<a href="http://','theme','tf.com" title="Download Free WordPress Responsive Themes" rel="follow">themetf</a>';
	}
	return $content;
}
add_action( 'tie_ad_content', 'tie_ad_post_content' );
